                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="supprimerFamille" method="post" enctype='multipart/form-data'>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Entrer le genre de famille </label>
                                                                <div class="col-sm-10">
                                                                    <input id="nomf"  name="nomf" type="text" class="form-control" placeholder="">
                                                                </div>
                                                            </div>
                                                            <b style="color: red">
                                                    ...
                                                    <div class="card-header">
                                                        <h5>Delete Product from a family</h5>
                                                    </div>
                                                     <div class="card-block">
                                                        <form action="supprimerProduit" method="post" enctype='multipart/form-data'>
                                                            <div class="form-group row">
