...
<head>
    <title>Admin delete family/product</title>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Vous pouvez modifier sur cette famille en changeant les valeurs </h5>
                                                    </div>
                                                    <div class="card-block">
                                                        
                                                        <form action="modifierFamille" method="post" enctype='multipart/form-data'>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Nom de famille </label>
                                                                <div class="col-sm-10">
                                                                    <input id="nomf"  name="nomf" type="text" class="form-control" value="">
                                                                </div>
                                                            </div>
                                                            <b style="color: red">
                                                            <c:if test="${not empty existePas}"> 
                                                             <c:out value="${existePas}" />
                                                            </c:if>
                                                            </b><br>
                                                    ...
                                                    <div class="card-header">
                                                        <h5>Vous pouver modifier sur ce produit en changeant les valeurs </h5>
                                                    </div>
                                                     <div class="card-block">
                                                        <form action="modifierProduit" method="post" >
                                                            <div class="form-group row">
                                                                ...
                                                                <div class="col-sm-10">
                                                                    <input name="nou" type="text" class="form-control" value="${produit.nomProduit }">
                                                                </div>
                                                                </div>
                                                                <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Prix du produit </label>
                                                                <div class="col-sm-10">
                                                                    <input name="nouv" type="text" class="form-control" value="${produit.puProduit }">
                                                                </div>
                                                                </div>
                                                              <b style="color: red">
                                                            <c:if test="${not empty existePas}"> 
