                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card table-card">
                                                    ...
                                                    <div class="card-block">
                                                       ...
                                                       <c:set var="counterb" value="0"/>
                                                       <c:set var="counterc" value="0"/>
                                                       <c:set var="counterd" value="0"/>        
                                                            <c:forEach items="${cmds}" var="cmdss">       
                                                                    <tr>
                                                                        <td>
                                                                            <div class="d-inline-block align-middle">
                                                                                ...
                                                                                <div class="d-inline-block">
                                                                                    <h6>Commande №
              <c:set var="listLength" value="${cmds.size()}"/>
<c:choose>
    
    <c:when test="${counter lt listLength}">
        <c:out value="${cmds.get(counter)}"/>
...
<c:choose>
     ...
     <c:when test="${counter lt listLength}">
        <c:out value="${dates.get(counter)}"/>
                                                                                      ...
                                                                                      <p class="text-muted m-b-0">Adresse :
                                                                                      
                               <c:set var="listL" value="${cmds.size()}"/>
<c:choose>
    <c:when test="${counter lt listLength}">
        <c:out value="${adresses.get(counter)}"/>
       </c:when>
                                                                                        ...
                                                                                        <p class="text-muted m-b-0">Nom client :
