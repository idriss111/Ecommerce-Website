...
<head>
    <title>Admin add family/product</title>
        ...
        <div class="pcoded-container navbar-wrapper">
                        ...
                        <ul class="nav-right">
                            <li class="header-notification">
                                ...
                                <ul class="show-notification">
                                    ...
                                    <lai class="waves-effect waves-light">
                                        <div class="media">
            ...
            <div class="pcoded-main-container">
                <div class="pcoded-wrapper">
                   <c:import url="/Admin/navAdmin.jsp"></c:import>
                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-block">
                                                        ...
                                                        <form action="ajouterFamille" method="post" enctype='multipart/form-data'>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Entrer le genre de famille </label>
                                                                <div class="col-sm-10">
                                                                    <input id="nomf"  name="nomf" type="text" class="form-control" placeholder="tel">
                                                                </div>
                                                                
                                                                <label class="col-sm-2 col-form-label">Photo de famille</label>
                                                                <div class="col-sm-10">
                                                                    <input name="photoFamille" type="file" class="form-control"  accept=".jpg, .jpeg, .png">
                                                                </div>
                                                                

                                                            </div>
                                                                <input type="submit" class="btn waves-effect waves-light btn-primary btn-outline-primary"><i class="icofont icofont-user-alt-3"></i>

                                                        </form>
                                                    </div>
                                                    <div class="card-header">
                                                        <h5>Add Product from a family</h5>
                                                    </div>
                                                     <div class="card-block">
                                                        <form action="ajouterProduit" method="post" enctype='multipart/form-data'>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Entrer le nom de produit </label>
                                                                <div class="col-sm-10">
                                                                    <input name="nomProduit" type="text" class="form-control">
                                                                </div>
                                                                <label class="col-sm-2 col-form-label">Entrer le prix du produit </label>
                                                                <div class="col-sm-10">
                                                                    <input name="prixProduit" type="number" class="form-control" pattern="[1-9][0-9]*">
                                                                </div>
                                                                
                                                                <label class="col-sm-2 col-form-label">Photo de produit</label>
                                                                <div class="col-sm-10">
                                                                    <input name="photoProduit" type="file" class="form-control">
                                                                </div>
