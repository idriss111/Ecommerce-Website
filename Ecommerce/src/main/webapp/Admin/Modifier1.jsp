                                            ...
                                            <div class="col-sm-12">
                                                ...
                                                <div class="card">
                                                    <div class="card-header">
                                                        <h5>Modify familly</h5>
                                                    </div>
                                                    <div class="card-block">
                                                        
                                                        <form action="modifierFamille" method="post" enctype='multipart/form-data'>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Entrer le genre de famille a modifier </label>
                                                                <div class="col-sm-10">
                                                                    <input id="nomf"  name="nomf" type="text" class="form-control" placeholder="">
                                                                </div>
                                                            </div>
                                                            <b style="color: red">
                                                            <c:if test="${not empty existePass}"> 
                                                             <c:out value="${existePass}" />
                                                            </c:if>
                                                            </b><br>
                                                    ...
                                                    <div class="card-header">
                                                     ...
                                                     <div class="card-block">
                                                        <form action="modifierProduit" method="post" enctype='multipart/form-data'>
                                                            <div class="form-group row">
                                                                <label class="col-sm-2 col-form-label">Entrer le nom de produit a modifier </label>
                                                                <div class="col-sm-10">
